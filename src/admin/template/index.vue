      ...
      >
          ...
          <el-col :span="8">
            ...
            >
              <el-upload
                class="img-uploader"
                name="upload"
                :action="$store.state.api+'template/picture'"
                :headers="headers"
                :show-file-list="false"
                :on-success="picSuccess"
              >
                <img
                  v-if="form.fullpathPicture"
                  :src="form.fullpathPicture"
                  class="img"
                >
                <i
                  v-else
        ...
        >
          ...
          <el-upload
            class="upload"
            name="upload"
            :action="$store.state.api+'template/source/'"
            :headers="headers"
