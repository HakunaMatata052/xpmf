        ...
        <div class="foot-header">
          <div class="center clearfix">
            ...
            <div class="foot-h-r">
              ...
              <a
                :href="'//wpa.qq.com/msgrd?V=1&uin='+$store.state.siteinfo.qq+'&Site=xpmof.com&Menu=no'"
                target="_blank"
                class="service"
              >24小时在线客服</a>
            </div>
